...
public interface CategoryRepository extends JpaRepository<Category, Long> {
     ...
     * @param status The status of the category to filter by (e.g., ACTIVE, DELETED).
     * @return       An Optional containing the found Category if it exists and matches the status, or empty otherwise.
     */
